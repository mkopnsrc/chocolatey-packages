...
$packageArgs = @{
    ...
    installerType  = 'exe'
    url            = 'https://www.moderncsv.com/release/ModernCSV-Win-v2.4.3.exe'
    url64bit       = 'https://www.moderncsv.com/release/ModernCSV-Win-v2.4.3.exe'
    checksum       = '07de7854264beb10e28469fa60977757796f4ef098c917ef2f613c953b22a788'
    checksumType   = 'SHA256'
    checksum64     = '07de7854264beb10e28469fa60977757796f4ef098c917ef2f613c953b22a788'
