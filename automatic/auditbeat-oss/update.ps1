...
$releases = 'https://www.elastic.co/downloads/beats/auditbeat-oss'
$ChecksumType = 'SHA256'
...
function global:au_GetLatest() {
    ...
    $url   = "https://artifacts.elastic.co/downloads/beats/auditbeat/auditbeat-oss-$($version)-windows-x86_64.msi"
    $url64 = "https://artifacts.elastic.co/downloads/beats/auditbeat/auditbeat-oss-$($version)-windows-x86_64.msi"
